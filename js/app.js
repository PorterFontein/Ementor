(() => {
    ...
    function menuIn() {
        if (document.querySelector(".icon-menu-course")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu-course")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open-course");
            }
        }));
    }
